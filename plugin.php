...
function guteblock_render_post_grid_block($attributes) {
	...
	if($query->have_posts()) {
		...
		while($query->have_posts()) {
			...
			$posts .= '<h4 style="font-size: '.$attributes['title_fontsize'].'px;"><a href="'. esc_url(get_the_permalink()) . '">'. get_the_title() . '</a></h4><div style="font-size: '.$attributes['content_fontsize'].'px;">';
